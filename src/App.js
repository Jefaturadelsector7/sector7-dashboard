...
import DirectorioSupervisiones from "./components/DirectorioSupervisiones";
        ...
        {userRole === "admin" && (
          <div>
            <div style={{ display: "flex", gap: "10px", marginBottom: "30px", borderBottom: "2px solid #e5e7eb", flexWrap: "wrap" }}>
              ...
              <button onClick={() => setActiveTab("directorio")} style={{ padding: "10px 20px", background: activeTab === "directorio" ? "#2563eb" : "transparent", color: activeTab === "directorio" ? "white" : "#666", border: "none", cursor: "pointer", fontWeight: "600" }}>👥 Directorio</button>
