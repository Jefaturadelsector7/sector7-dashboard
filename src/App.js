  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f5f5" }}>
      ...
      <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
                      ...
                      <tbody>
                        {supervisiones.map((supervision) => (
                          <tr key={supervision.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
                            ...
                            <td style={{ padding: "12px" }}><button onClick={() => eliminarSupervision(supervision.id)} style={{ padding: "5px 10px", background: "#dc2626", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", fontSize: "12px" }}>Eliminar</button></td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
        ...
        {userRole === "supervisor" && (
          <div><h2 style={{ color: "#1e40af", marginBottom: "20px" }}>Escuelas de {userZona}</h2>
            <div style={{ background: "white", padding: "20px", borderRadius: "8px" }}>
              {escuelas.length === 0 ? <p style={{ color: "#666" }}>No hay escuelas</p> : (
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
                  <thead><tr style={{ background: "#f3f4f6", borderBottom: "2px solid #e5e7eb" }}>
                    <th style={{ padding: "12px", textAlign: "left", fontWeight: "600" }}>Escuela</th>
                    <th style={{ padding: "12px", textAlign: "left", fontWeight: "600" }}>Director</th>
